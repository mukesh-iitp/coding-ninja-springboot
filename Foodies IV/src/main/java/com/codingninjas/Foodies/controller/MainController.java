...
public class MainController {
	...
	public List<Customer> getCustomersByVisitedRestaurants(@PathVariable String restaurantName){
		return service.getCustomersByVisitedRestaurants(restaurantName);
	}
	
	@GetMapping("/customers/restaurant/{restaurantName}/{rating}")
	public List<Customer> getCustomersWhoRatedResturantGreater(@PathVariable String restaurantName,@PathVariable double rating){
		return service.getCustomersWhoRatedResturantGreater(restaurantName, rating);
	}
	
	@GetMapping("/restaurant/{restaurantName}/average")
	public Double findRatingAverageRestaurant(@PathVariable String restaurantName){
		return service.findRatingAverageRestaurant(restaurantName);
	}
