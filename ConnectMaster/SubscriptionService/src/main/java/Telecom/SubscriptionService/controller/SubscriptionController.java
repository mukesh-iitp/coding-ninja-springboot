...
public class SubscriptionController {
    ...
    @HystrixCommand(fallbackMethod = "fallbackcreateSubscription")
    ...
    public ResponseMessage fallbackcreateSubscription(@RequestBody SubscriptionDto subscriptionDto) {
    	return new ResponseMessage("Service in not available");
    }
