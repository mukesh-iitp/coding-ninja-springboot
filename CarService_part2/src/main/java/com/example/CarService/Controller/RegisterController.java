...
**/
    ...
    public String getRegistrationPage(Model uiModel){
    	...
    	//Vehicle car = carRegistrationService.getNewCar();
  ...
  */
    ...
    public String getResponsePage(@ModelAttribute(value="car") Car car ){
    	...
    	//if(carRegistrationService.registerCar(car.getRegisterationNumber(), car.getCarName(), car.getCarDetails(), car.getCarWork()))
    		return "success";
    	else
    		return "carregister";
    }
