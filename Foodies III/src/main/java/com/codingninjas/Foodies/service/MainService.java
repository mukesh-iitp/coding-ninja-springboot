...
public class MainService {
	...
	public List<Customer> getCustomersByVisitedRestaurants(String restaurantName) {
		Restaurant restaurant = this.getRestaurantByName(restaurantName);
		return customerRepository.findByVisitedRestaurants(restaurant);
	}

	public List<Customer> getCustomersWhoRatedResturantGreater(String restaurantName, double rating) {
		return customerRepository.getCustomersWhoRatedResturantGreater(restaurantName, rating);
	}
